...
line containing:
    ...
    use the command line option `-o simple`. For example `python train_frcnn.py -o simple -p my_data.txt`. Only images with imageset set to either `train` or `val` will be used.
